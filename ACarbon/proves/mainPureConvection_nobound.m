...
%Problem data
finalTime=80;
velocityFunction=@(X) [ux uy]; %definition of the velocity
...
nOfElem1d = 50;
typeOfElement = 1;
[X,T] = CreateMesh(typeOfElement,3,[0,12,0,15],nOfElem1d,nOfElem1d); %Definition of the mesh
...
tol=1.e-10; flowSides=find( (abs(XmidSides(:,2))<tol & abs(XmidSides(:,1)-10.2) < 1)| (abs(XmidSides(:,2)-15)<tol & abs(XmidSides(:,1)-2) < 1))';
